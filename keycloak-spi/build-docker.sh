...
echo "=========================================="
echo "Astrago Keycloak SPI 빌드 및 푸시 (Docker)"
echo "=========================================="

# 1. Maven 빌드 (Docker 사용)
echo "1. Maven 빌드 중 (Docker)..."
docker run --rm -v $(pwd):/app -w /app maven:3.9.6-openjdk-17 mvn clean package -DskipTests
